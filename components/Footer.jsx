  ...
  return (
    <footer className="bg-[var(--surface)] text-[var(--foreground)]">
      <div className="flex flex-col md:flex-row items-start justify-center px-6 md:px-16 lg:px-32 gap-10 py-14 border-b border-[var(--border)] text-[var(--foreground)]/80">
        <div className="w-4/5">
          ...
          <p className="mt-6 text-sm">
            مرحبًا بكم في متجرنا! نحن ملتزمون بتقديم أفضل المنتجات والخدمات لعملائنا. استمتعوا بتجربة تسوق ممتعة ومريحة معنا.
        ...
        <div className="w-1/2 flex items-start justify-start md:justify-center">
          <div>
            <h2 className="font-medium text-[var(--foreground)] mb-5">تواصل معنا عبر</h2>
            <div className="text-sm space-y-2">
              <p>+20-10-40450320</p>
              <p>Asmaa.beauty@gmail.com</p>
            </div>
            <div className="mt-4 flex items-center gap-3">
              ...
              <a href="https://wa.me/201040450320" aria-label="WhatsApp" className="inline-flex rounded-full border border-[var(--border)] p-2 hover:bg-[var(--surface-muted)] transition">
      ...
      <p className="py-4 text-center text-xs md:text-sm">
        Copyright 2025 © Asmaa-Beauty All Right Reserved.
      </p>
    </footer>
  );
};
